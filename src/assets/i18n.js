  ...
  'en': {
    ...
    InfoCards: {
      ...
      Experience: {
        ...
        TitleTwelveth: "Mar. 2022 ~ May. 2022 - [Freelance] Rifaisso",
        TitleThirteenth: "May. 2022 ~ Now - [Junior Development Analyst] Mutant - Vivo",
        TextFirst: "I took part into the development of the first versions of \"TeachLearn\", developed in Vue.js with Quasar and Node.js with Express.js. My tasks involved front-end and back-end development, but my tasks were mainly on the API's endpoints development. " +
        ...
        TextThird: "To conclude my Computer Engineering course, I did an internship at \"Dourasoft\", where I developed an OCR functionality to be integrated into company's developed and commercialized system. It was done with Amazon Textract (OCR). " + 
        ...
        TextFourth: "[Project available on GitHub] For the development of this page, I've set a extras challenges for me, the use Vue.js with bootstrap, which I haven't done previously, and the development of a CSS animation exclusively for this page. The goal is try to show that I can learn and accomplish a given activity.",
        ...
        TextSeventh: "\"Agriv\" is a system to collect soil data through a Wireless Sensor Network, developed for the Computer Engineering course final paper, with another student, my role was to develop the network and put together all the hardware. " +
        ...
        TextEigth: "[Project available on GitHub] \"PassRemind\" is a password manager web app for personal use, it was developed using Vue.js with Vuetify and firebase, more than that, a browser plugin was developed as well. Although, it is not a complex system, this project had its importance for introducing me to the development of browser plugins and the use of Firebase Functions and Firebase Hosting.",
        TextNineth: "I've been involved in the front end and back end development of some of the system's functionalities. Which was made to manage restaurant checks. It was developed in Vue.js and Node.js with Express.js. Unfortunately, although its first commercial version was fully developed, the project came to an end before being publicly available due to market research.",
        TextTenth: "During college, I've done an extracurricular internship at UFGD's \"COIN - Coordenadoria de Informática\", in customer support, where most activities envolved assisting university staff with computer problems and internet and intranet connection problems.",
        TextEleventh: "To conclude my Electronics Technician course, I did an internship at \"Aureon\", a company that, at the time, commercialized and manufactured analog emergency lightning systems. There, I've calibrated and fixed products on the production line.",
        TextTwelveth: "I fully developed an API for \"Rifaisso\", from its beginning to the first commercial version. It was developed using Typescript with AdonisJs and docker. During the development, I integrated the \"mercado pago\" API, made CRON routines, and learned AdonisJs and Docker implementation, which was my first time implementing them.",
        TextThirteenth: "Employed by \"Mutant\", I was allocated to work for \"Vivo\". The job consists of the development and maintenance of the use case dialogs for the company's AI, \"Aura\", in the context of customer service via WhatsApp. In this job, I'm deepening my knowledge of Agile Methodologies, typescript, use of javascript classes and npm packages development."
      },
      Personal: {
        PageTitle: "About Me",
  ...
  'pt': {
    ...
    InfoCards: {
      ...
      Experience: {
        ...
        TitleThirteenth: "Mai. 2022 ~ Atual - [Analista de Desenvolvimento Jr.] Mutant - Vivo",
        TextFirst: "Participei no desenvolvimento das primeiras versões do sistema \"TeachLearn\", desenvolvido em Vue.js com Quasar e Node.js com Express.js. Realizei atividades tanto no front-end quanto no back-end, porém a maioria delas foram focadas no desenvolvimento de endpoints da API do sistema. " +
        ...
        TextFourth: "[Projeto presente no GitHub] Para o desenvolvimento dessa página, eu propus alguns desafios extras para mim mesmo, ao usar pela primeira vez o Vue.js com Bootstrap para o desenvolvimento deste portfolio, além do desenvolvimento de uma animação CSS exclusivamente para esta página. Isto para tentar mostrar que eu tenho a capacidade de aprendizado para cumprir uma atividade designada.",
        ...
        TextNineth: "Estive envolvido no desenvolvimento de back-end e front-end de algumas funcionalidades deste sistema de gerenciamento de comandas para restaurantes. Ele foi feito em Vue.js e Node.js com ExpressJs. Infelizmente, apesar de ter sua primeira versão finalizada, devido à pesquisas de mercado, o projeto foi interrompido antes de ser comercializado.",
